...
public class BrowserGeneric {

	public static void main(String[] args) {
		/**
		 * Step1: set the path of required browser executable file using
		 * System.setProperty(key, value) path: 1. absolute path -->
		 * F:\\JavaWorkspace\\SeleniumTesting\\Executables\\chromedriver.exe 2. Relative
		 * path --> .\\Executables\\chromedriver.exe Step2: create an instance of
		 * required browser class
		 */
